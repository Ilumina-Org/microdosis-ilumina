...
const Testimonials = React.forwardRef<HTMLDivElement, LandingProps>((props, ref) => {
    return (
        <SectionLayout id={props.id} ref={ref} horizontalPadding={0}>
            <div style={{ 
                ...
                <div style={{
                    ...
                    <iframe width="760" height="415" src="https://www.youtube.com/embed/qRTVg8HHzUo?si=oT9nLeT7KbVrjKc6" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
                <TestimonialCarousel />
            </div>
        </SectionLayout>

...
import { manifest } from './manifest_Bkyxf5WX.mjs';
...
const _page12 = () => import('./pages/api/orders/_orderid_.astro.mjs');
const _page13 = () => import('./pages/api/orders.astro.mjs');
const _page14 = () => import('./pages/api/save-address.astro.mjs');
const _page15 = () => import('./pages/api/save-payment.astro.mjs');
const _page16 = () => import('./pages/failure.astro.mjs');
const _page17 = () => import('./pages/microdosis-package/_sku_.astro.mjs');
const _page18 = () => import('./pages/pending.astro.mjs');
const _page19 = () => import('./pages/success.astro.mjs');
const _page20 = () => import('./pages/suscription.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/orders/[orderId].ts", _page12],
    ["src/pages/api/orders/index.ts", _page13],
    ["src/pages/api/save-address.ts", _page14],
    ["src/pages/api/save-payment.ts", _page15],
    ["src/pages/failure.astro", _page16],
    ["src/pages/microdosis-package/[sku].astro", _page17],
    ["src/pages/pending.astro", _page18],
    ["src/pages/success.astro", _page19],
    ["src/pages/suscription.astro", _page20],
...
const _args = {
    "middlewareSecret": "6fcd2174-597b-441f-bd04-802a7e899edb",
